...
;; coin-values affect the answer produced by cc? Why orwhy not? 
...
(define change-counting-tests
  (test-suite
   "Change counting procedure using lists. 2.19 sicp exercise"
   (check-equal? (cc 100 us-coins) 292)
   (check-equal? (cc 100 '(1 5 10 25 50)) 292)
   (check-equal? (cc 100 '(1 5 50 10 25)) 292)))
