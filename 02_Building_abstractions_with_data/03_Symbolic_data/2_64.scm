...
;;; partial-tree takes a ordered list of elements and a integer n. It
;;; takes the first n elements of the list and it contructs the left
;;; branch and right branch of the tree taking the first and the
;;; second halves of elements. The element in the middle will be the
;;; entry for the tree
